...
$break_name=explode(".",$data['username']);
$surname=$break_name[0].".";
$name=$break_name[1];
?> 
 	<form id="form" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
					<div class="col-lg-1" style="width:100px;">
							...
							<select name="surname" id="surname" class="form-control">
								<option value="Mr." <?php if($surname=="Mr.") echo"selected"; ?>>Mr.</option>
								<option value="Mrs." <?php if($surname=="Mrs.") echo"selected"; ?>>Mrs.</option>
							</select>
					</div>
                    <div class="form-group col-lg-5">
                        ...
                        <div class="col-lg-12">
						<input class="text-input form-control" name="username" value="<?=$name;?>" type="text" />
					   </div>
                    </div>
                    <div class="form-group col-lg-6">
                        ...
                        <div class="col-lg-12">
						<input class="text-input form-control" name="mobile" value="<?=$data['mobile'];?>" type="text" />
					   </div>
                    </div>
                    <!--<div class="form-group col-lg-6">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="col-lg-12">
						<input class="text-input form-control" name="email" value="<?=$data['email'];?>" type="email" />
					</div>
                    </div>
					<div class="form-group col-lg-6">
                        ...
                        <div class="col-lg-12">
						<input class="text-input form-control" name="city" value="<?=$data['city'];?>" type="text" />
					</div>
                    </div>
					<div class="form-group col-lg-6">
                        ...
                        <div class="col-lg-12">
						<input class="text-input form-control" name="address" value="<?=$data['address'];?>" type="text" />
					</div>
                    </div>
                    ...
                    <div class="form-group col-lg-6">
                        <div class="col-lg-12" style="text-align:right;">
							<input class="btn btn-primary col-md-12" style="margin-top:25px;" type="submit" name="submit" value="Update" />
						</div>
                    </div>
				</div>
            </form>
