...
<div class="panel panel-default">
			...
			<form id="form" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
					...
					<div class="form-group">
                        ...
                        <div class="col-lg-8">
						<input class="form-control" name="mob_number" type="text" />
						</div>
                    </div>
					<div class="form-group">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php foreach($data as $d){ ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo $d["active"]; ?></td>
                                            <td class="center"><?php echo $d["type"]; ?></td>
                                            <td class="center">
                                             <a href="<?php echo common::get_component_link(array('user','edit')).'&id='.$d['id']; ?>" class=""  title="Edit"  style="float: left; padding: 5px;" ><i class="glyphicon glyphicon-pencil"></i></a>
										 <a href="<?php echo common::get_component_link(array('user','delete')).'&id='.$d['id']; ?>" class="" style="float: left; padding: 5px;"  title="Delete"><i class="glyphicon glyphicon-remove"></i></a> 
