...
<html lang="en">
  <head>
   <!--Mobile first-->
    ...
    <link rel="stylesheet" href="<?php echo DEFAULT_THEME; ?>css/style.css">
    <!--[if lt IE 9]>
...
<header>
    ...
    <div class="row">
        <div class="col-lg-3">
        <img src="<?php echo ADMIN_THEME ?>img/logo.png" />
        </div>
        <div class="col-lg-9">
        <div class="cart-box">
      ...
      Items : <span id="CartItems">  <?php echo count($_SESSION["designno"]); ?></span>
    ...
    <div class="dropdown-menu" id="DW-Cart-Item" style="margin-left: -120px; padding: 10px;">
        <div><i class="glyphicon glyphicon-align-justify"></i>&nbsp;<a href="javascript:;" id="ViewCart">View Cart</a></div>
            ...
            <div><i class="glyphicon glyphicon-log-out"></i>&nbsp;<a href="<?php echo common::get_component_link(array("home","logout")); ?>" >Logout</a></div>
        </ul>
      <?php
...
<div class="row">
    <div class="col-lg-3">
        ...
        <form action=""  method="post">
            ...
            {
                ?>
                <option value="<?php echo $size["id"] ?>"><?php echo $size["alias"]; ?></option>
                <?php
            }
            ?>
            </select>
