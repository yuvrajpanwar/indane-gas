        ...
        <div id="content">
			...
			<form id="form" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
						<input class="text-input" name="username" value="<?php echo $data["username"]; ?>" type="text" />
					   </div>
                    </div>
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Password</label>
                        <div class="col-lg-8">
                        <input class="text-input" name="temppassword" value="<?php echo $data["password"]; ?>" type="hidden" />
						<input class="text-input" name="password" value="<?php echo $data["password"]; ?>" type="password" />
					</div>
                    </div>
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Email</label>
                        <div class="col-lg-8">
						<input class="text-input" name="email" type="email" value="<?php echo $data["email"]; ?>" />
					</div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
						<select name="active">
                            <option value="<?php echo $data["active"]; ?>"></option>
