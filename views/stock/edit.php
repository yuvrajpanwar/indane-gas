                    ...
                    <?php if ( common::do_show_message() ) {
        		          echo common::show_message();	
                            ...
                            <div class="form-group">
                            	<div class="col-md-9">
        						  <label>Product</label>
                                  <select data-placeholder="Choose a country..." name="prid" id="prid" class="form-control chosen-select" disabled>
                                  	<option>Choose Product Name</option>
                                  	<?php 
                                  		foreach ($data1 as $title)
                                  		{
											if($title["id"]==$product_id)
											{
												
											
                                  	?> 
                                  	
                                     <option  value="<?php echo $title["id"]; ?>" selected><?php echo $title["title"];?> 
							...
							<div class="form-group">
								<div class="col-lg-4">
									  ...
									  <input type="text"  class="form-control"  name="in_number" value="<?php echo $data['invoice_number'];?>" id="in_number" />
								</div>
								<div class="col-lg-4">
									  <label>Invoice Date</label>
									  <input type="text"  class="form-control datepicker" value="<?php echo $data['invoice_date'];?>" name="invoice_date" id="invoice_date" />
								</div>
								 <div class="col-lg-4">
									  <label>Party Name</label>
									  <input type="text"  class="form-control" value="<?php echo $data['vendor_name'];?>" name="name" id="name" />
								</div>
							</div>
                            <div class="form-group">
                             <div class="col-lg-2">
        						  <label>Qty</label>
                                  <input type="number"  class="form-control" name="gmqty" value="<?=$data["gmqty"]?>" />
							</div>
                            <div class="col-lg-2">
        						  <label>Unit</label>
