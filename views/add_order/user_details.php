...
<div class="panel panel-default">
			...
			<div class="col-lg-12" id="row_container">	
                    ...
                    <div class="col-lg-12">
                        <div class="col-lg-6">
						<a class="col-md-6"></a>
						<a class="btn btn-primary col-md-6" href="<?php echo common::get_component_link(array('add_order','edit_products_details'),array("id"=>$order_id,"type"=>$user_type,"order_type"=>'new')); ?>">Back</a>
						</div>
						<div class="col-lg-6">
							<input class="btn col-md-6 btn-primary" id="final_done" type="submit" name="add" value="Next" />
						</div>
