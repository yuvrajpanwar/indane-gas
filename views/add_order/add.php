										...
										<div class="table-responsive">
											<table class="table table-striped table-bordered table-hover" id="" >
												...
												<tr class="odd gradeX">
													...
													<td>
													<label id="cgst_lb-<?=$count?>"><?php echo round($cgst_amount,2); ?></label>
													<!--<input type="hidden" name="cgst[]" id="cgst-<?=$id?>" value="<?php echo $cgst_amount; ?>" readonly>-->
													</td>
													
													<td>
													<label id="sgst_lb-<?=$count?>"><?php echo round($sgst_amount,2); ?></label>
													<!--<input type="hidden" name="sgst[]" id="sgst-<?=$id?>" value="<?php echo $sgst_amount; ?>" readonly>-->
													</td>
													
													<td>
													<label id="total_amount_lb-<?=$count?>"><?php echo round($amount,2); ?></label>
