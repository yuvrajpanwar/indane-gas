   ...
   if(isset($_POST['add']))
    {
        ...
        if(form_validation::validate_fields())
        {
           ...
           // addProduct(array("admin_id"=>$login_id,"title"=>$title,"slug"=>common::generateSlug(TBL_PRODUCTS,$title),"description"=>strip_tags($description),"price"=>$price,"gmqty"=>$gmqty,"unit"=>$unit,"type"=>"retiail","status"=>"1","currency"=>CURRENCY));
