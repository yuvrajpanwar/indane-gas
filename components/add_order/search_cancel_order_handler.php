...
{
	$data = getSaleCancel($login_id);
}

if($user_type=="Registered")
{
	$data = getRegisterSaleCancel($login_id);
}
...
if($data)
{
	...
	{ 
		...
		$edit_link=common::get_component_link(array('add_order','edit_products_details'),array("id"=>$d['id'],"type"=>$user_type));
		if($user_type=="General")
		{
